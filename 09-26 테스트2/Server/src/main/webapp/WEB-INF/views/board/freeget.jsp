        ...
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
             ...
             <div class="card mb-4 p-4">
				  ...
				  <input type="text" class="form-control" id="IDX" readonly value='<c:out value="${freegettt.IDX}"/>'>
				  <label>번호</label>
				</div>		
			
				<div class="form-floating mb-3">
				  <input type="text" class="form-control" id="CUM_TITLE" readonly value='<c:out value="${freegettt.CUM_TITLE}"/>'>
				  <label>제목</label>
				</div>			
				<div class="form-floating mb-3">
					<textarea class="form-control"  id="CUM_CONTENTS" name="CUM_CONTENTS" readonly style="height: 300px"><c:out value="${freegettt.CUM_CONTENTS}"/></textarea>
				   <label>내용</label>
				</div>	
				<div class="form-floating mb-3">
				  <input type="text" class="form-control" id="CUM_WRITER" readonly value='<c:out value="${freegettt.CUM_WRITER}"/>'>
				  <label>작성자</label>
				</div>
<!-- 				<div class="form-floating mb-3">
